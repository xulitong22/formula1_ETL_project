...
# MAGIC %md
# MAGIC #### Step1 - Read csv file using dataframe reader API
...
lap_times_with_ingestion_date = add_ingestion_date(lap_times_df)
...
final_df = lap_times_with_ingestion_date.withColumnRenamed("raceId", "race_id") \
